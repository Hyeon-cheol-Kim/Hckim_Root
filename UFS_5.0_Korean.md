...
| 기어 (Gear) | 레인당 속도 | x1 최대 속도 | x2 최대 속도 |
|-------------|-------------|-------------|-------------|
| HS-G1 | 1.248 Gbps | ~1,200 MB/s | ~2,400 MB/s |
| HS-G2 | 2.496 Gbps | ~2,400 MB/s | ~4,800 MB/s |
| HS-G3 | 4.992 Gbps | ~4,800 MB/s | ~9,600 MB/s |
| HS-G4 | 9.984 Gbps | ~9,600 MB/s | ~19,200 MB/s |
| HS-G5 | 23.2 Gbps | ~23,000 MB/s | ~46,000 MB/s |

> **UFS 5.0 신규**: HS-G5 도입으로 레인당 최대 23.2 Gbps 달성
...
| 파라미터 | 값 |
|----------|-----|
| 차동 신호 진폭 | 200 mVpp (typ) |
| 공통 모드 전압 | 0~0.7 V |
| 신호 임피던스 | 50 Ω (단종단), 100 Ω (차동) |
...
| 항목 | UFS 3.1 | UFS 4.0 | UFS 5.0 |
|------|---------|---------|---------|
| 최대 순차 읽기 | ~2,100 MB/s | ~4,200 MB/s | ~8,533 MB/s |
| 최대 순차 쓰기 | ~1,200 MB/s | ~2,800 MB/s | ~4,200 MB/s |
| 최대 랜덤 읽기 (4K IOPS) | ~100K IOPS | ~200K IOPS | ~400K IOPS |
| 최대 랜덤 쓰기 (4K IOPS) | ~70K IOPS | ~150K IOPS | ~300K IOPS |
| 물리 레인 속도 | HS-G4 (11.6 Gbps) | HS-G4 (23.2 Gbps) | HS-G5 (46.4 Gbps) |
| 최대 큐 깊이 | 32 | 32 | 256 |
...
| 항목 | 변경 내용 |
|------|----------|
| M-PHY 기어 | HS-G5 신규 추가 (레인당 23.2 Gbps → 46.4 Gbps) |
| 큐 깊이 | 32 → 256으로 확장 |
| 순차 읽기 속도 | 최대 ~4,200 MB/s → ~8,533 MB/s |
